...
public class CuentaPagar {
    ...
    private String nombreCuentPagar;
    private String mes;
    ...
    public CuentaPagar(String nombreCuentaCobrar, String mes, int anio, int semana, double valor) {
        this.nombreCuentPagar = nombreCuentaCobrar;
        this.mes = mes;
        this.anio = anio;
    ...
    public void setIdCuentaCobrar(int idCuentaCobrar) {
        this.idCuentaPagar = idCuentaCobrar;
    }
